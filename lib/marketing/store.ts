...
const b2bContent = { heading: "Welcome to Corals Anonymous Wholesale!", body: ["Hi Corals","","We are thrilled to welcome you to the Corals Anonymous Wholesale family!","","Here is what you can look forward to as a Corals Anonymous Wholesale customer:","","- Rotating super sales every week with new items added daily.","- WYSIWYG weekends, where selected items are 50-80% off every Friday at 7 AM PST.","- A 10% off coupon code on your first order when you sign up for our newsletter.","","Get started by logging into your wholesale account. Click the button below to visit our homepage and sign in. Please reach out if you have any questions!","","Best regards,","Corals Anonymous Team"].join(String.fromCharCode(10)), button: "Sign In & Buy Now!", url: "https://coralsanonymous.com", preview: "Welcome to Corals Anonymous Wholesale!" };
