...
export function SpeciesPublicationControl({ ready, cards, pendingCommerce, lastPublishedAt }: { ready: boolean; cards: number; pendingCommerce: number; lastPublishedAt: string | null }) {
