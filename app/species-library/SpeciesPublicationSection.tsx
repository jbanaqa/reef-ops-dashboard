...
export async function SpeciesPublicationSection() {
  let readiness = { ready: false, upToDate: false, cards: 0, changedCards: 0, canonicalCards: 0, newCards: 0, pendingCommerce: 0, blockReason: "Publication readiness could not be verified." as string | null, lastPublishedAt: null as string | null };
