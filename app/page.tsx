...
const tools = [
  { title: "Receive shipment", description: "Import an RVS invoice, match products, and add confirmed stock to Shopify.", href: "/receive-shipment", icon: "shipment" },
...
export default async function DashboardPage() {
  ...
  return <div className="ops-home">
    <header className="ops-heading"><div><p className="ops-eyebrow">OPERATIONS WORKSPACE</p><h1>Your store, at a glance</h1><p>Review what needs attention, then pick up where you left off.</p></div><Link className="button button-primary" href="/receive-shipment"><ReefIcon name="shipment" size={17} />&nbsp; Receive shipment</Link></header>
